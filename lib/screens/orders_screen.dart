  ...
  Future<void> fetchOrders() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() {
          orders = data.map((j) => Order.fromJson(j as Map<String, dynamic>)).toList();
          isLoading = false;
        });
  ...
  Future<void> _cancelOrder(Order order) async {
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text('Yes, Cancel', style: GoogleFonts.poppins(fontSize: 13)),
          ),
        ],
      ),
    );
    ...
    if (!success) {
      try {
        ...
        if (r.statusCode == 200 || r.statusCode == 204) success = true;
      } catch (_) {}
    }
