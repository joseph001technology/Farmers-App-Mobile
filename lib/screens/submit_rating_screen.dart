...
class _SubmitRatingScreenState extends State<SubmitRatingScreen> {
  ...
  Future<void> _submitAll() async {
    ...
    if (unrated > 0) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Please tap the stars to rate all $unrated product${unrated == 1 ? '' : 's'}.',
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SingleChildScrollView(
            child: Text(msg, style: GoogleFonts.poppins(fontSize: 13, height: 1.5))),
        actions: [
          ElevatedButton(
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('How was Order #${widget.order.id}?',
                    style: GoogleFonts.poppins(
                        color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
                Text('Tap the stars to rate each product',
          ...
          if (items.isEmpty)
            Container(
              ...
              child: Column(children: [
                ...
                Text(
                  'The order was loaded without item details.\n'
                  'Try going back and tapping the order again.',
          ...
          if (items.isNotEmpty)
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(_isSubmitting ? 'Submitting…' : 'Submit Reviews',
  ...
  Widget _ratingCard(OrderItem item) {
    ...
    final done      = _submitted[item.productId] ?? false;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: done ? Border.all(color: Colors.green[300]!) : null,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (done)
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('Reviewed', style: GoogleFonts.poppins(
        ...
        if (!done) ...[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center,
              children: List.generate(5, (i) {
                ...
                return GestureDetector(
                  onTap: () => setState(() => _ratings[item.productId] = v),
                  child: AnimatedScale(
                    scale: selected == v ? 1.25 : 1.0,
                    duration: const Duration(milliseconds: 150),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 6),
                      child: Icon(
                        v <= selected ? Icons.star_rounded : Icons.star_outline_rounded,
                        color: v <= selected ? Colors.amber : Colors.grey[300],
                        size: 38,
                      ),
                    ),
                  ),
          ...
          if (selected > 0) ...[
            ...
            Center(child: Text(_labels[selected],
                style: GoogleFonts.poppins(
                    fontSize: 13, color: Colors.amber[700], fontWeight: FontWeight.w600))),
          ],
